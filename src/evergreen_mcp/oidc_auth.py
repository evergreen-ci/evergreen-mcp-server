...
# Default DEX Configuration (fallbacks)
DEFAULT_DEX_ISSUER = "https://dex.prod.corp.mongodb.com"
DEFAULT_DEX_CLIENT_ID = "login"
DEX_SCOPES = "openid profile email offline_access groups"
...
class OIDCAuthManager:
    ...
    def __init__(self):
        ...
        self.issuer = oauth_config.get("issuer", DEFAULT_DEX_ISSUER)
        self.client_id = oauth_config.get("client_id", DEFAULT_DEX_CLIENT_ID)
        self.scopes = DEX_SCOPES
