...
ERROR_KEYWORDS: List[str] = [
    # Go
    "panic", "fatal", "FAIL", "runtime error", "goroutine",
    "deadlock", "nil pointer dereference", "index out of range",
    "slice bounds out of range", "invalid memory address",
    # Python
    "Traceback", "Exception", "Error", "raise", "AssertionError",
    ...
    "ClassNotFoundException", "OutOfMemoryError", "StackOverflowError",
    # Node / JS
    "ReferenceError", "SyntaxError", "UnhandledPromiseRejection",
    ...
    "401", "403",
    # Database
    "deadlock detected", "lock wait timeout", "duplicate key",
    "constraint violation", "connection pool exhausted",
    # Generic
    "CRITICAL", "FATAL", "EMERGENCY", "ALERT",
    "segfault", "core dumped", "killed", "signal",
